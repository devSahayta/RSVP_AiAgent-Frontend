...
const TestAgent = () => {
  ...
  const fetchAgent = async () => {
    try {
      const res  = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/agent-system/${agent_id}`);
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <button onClick={() => navigate(-1)} className="p-2 hover:bg-[#18181B] rounded-lg transition-colors">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                ...
                <span className="absolute -bottom-9 left-1/2 -translate-x-1/2 whitespace-nowrap bg-[#1A1A1E] text-xs text-gray-300 px-2 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none sm:hidden">
                  Test History
                </span>
              </motion.button>
          ...
          {mode === "chat" ? (
            ...
            >
                ...
                <div className="px-6 py-4 border-b border-[#1F1F23] bg-gradient-to-r from-purple-500/10 to-pink-500/10">
                  ...
                  <div className="mt-3 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                    <p className="text-xs text-blue-300 leading-relaxed">
                      🧪 <span className="font-semibold">Test Mode Active:</span> Document uploads (ID proof & travel
                      docs) are disabled. You can test the RSVP flow and ask questions about the event!
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-6 p-4 bg-[#111113] border border-[#1F1F23] rounded-xl">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Where is the wedding?", "What's the dress code?", "When is the wedding?", "Show me the schedule"].map((s, i) => (
            ...
            >
              <div className="text-center">
                  ...
                  {callStatus && (
                    <motion.div
                      ...
                      className={`max-w-md mx-auto mb-4 p-4 rounded-xl border flex items-start gap-3 ${
                        callStatus === "success" ? "bg-emerald-500/5 border-emerald-500/30"
                        : callStatus === "error"  ? "bg-red-500/5 border-red-500/30"
                    ...
                    >
                      ...
                      <div className="text-left">
                        <p className={`font-medium text-sm ${
                          callStatus === "success" ? "text-emerald-400"
                ...
                {/* ✅ Auto-deduction info note — shown after successful initiation */}
                <AnimatePresence>
                  {callStatus === "success" && (
                    <motion.div
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-400 leading-relaxed">
                        Credits are deducted automatically once your call ends — even if you close
                        this tab. Check your updated balance in{" "}
                        <button
                          onClick={() => navigate("/agents/test-history")}
                ...
                >
                  {voiceLoading ? (
                    ...
                    <><Phone className="w-5 h-5" /> {callStatus === "success" ? "Start Another Test" : "Start Voice Test"}</>
                  )}
                </button>
