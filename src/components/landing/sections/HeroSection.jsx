    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        <p className="hero-sub text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-4 opacity-0">
          Sutrak replaces manual guest calls and follow-ups with AI voice agents
          and WhatsApp bots that collect RSVPs, travel details, and
          confirmations — and turn them into optimized transport plans.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <Button
            ...
            size="lg"
            className="hero-btn opacity-0 bg-gradient-to-r from-secondary to-accent text-primary-foreground hover:opacity-90 transition-opacity px-8 text-base"
          >
