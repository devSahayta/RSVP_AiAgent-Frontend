  ...
  return (
    <section className="py-24 md:py-32 relative">
      <div className="max-w-4xl mx-auto px-4">
        <div
          ref={ref}
          className="glass-strong rounded-2xl p-10 md:p-16 text-center relative overflow-hidden"
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto mb-8">
              Join the first wave of event organizers using AI to eliminate
              guest coordination chaos.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                size="lg"
                className="bg-gradient-to-r from-secondary to-accent text-primary-foreground hover:opacity-90 transition-opacity px-8"
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-border/50 text-foreground hover:bg-muted/50 px-8"
                onClick={() => navigate("/contact")}
              >
                Book Demo
              </Button>
